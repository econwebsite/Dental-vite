      ...
      <div className="Contact-ted">
        <Form form={form} name="contactForm" onFinish={onFinish} layout="vertical">
          ...
          <Row justify="end">
            <Col>
              <Form.Item>
                <AnimatedButton type="primary" htmlType="submit" className='Contacts-btn' text="Submit" backgroundColor="#344ea1" animationColor="#69ba2f" hoverColor="yellow"></AnimatedButton>
              </Form.Item>
            </Col>
          </Row>
        </Form>
